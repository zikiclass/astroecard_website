...
<div class="row_head" style="margin-top: 1.5rem;">
   <div class="col-top">
   <div class="colt active_cu"><a href="masterOrder">Address</a></div>
    <div class="colt"><a href="masterorderReview">Order Review</a></div>
    <div class="colt"><a href="masterpayment">Payment</a></div>

</div>
<div class="col-head">
    
<form action="masterorderReview" method="POST" class="frm">
    @csrf
    <div>
...
<tr>
    ...
    <td class="rightItem">35,725.99 EUR</td>
</tr>
<tr>
...
<tr>
    <td>Total</td>
    <td class="rightItem"><b>35,725.99 EUR</b></td>
</tr>
...
<center><img src="img/card2.png" width="250" height="200"/><img src="img/card11.png" width="250" height="200"/></center>
</div>
